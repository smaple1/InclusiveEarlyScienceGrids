...
void Podio_ExtractYield_HeraBinning_10x250() {
  // Settings
  Float_t E_ebeam = 10;
  Float_t E_pbeam = 250;
  ...
  std::vector<TString> filenames = {
    "../../RECO/ep_10x250_Q2_1_10/filelist.txt",
    "../../RECO/ep_10x250_Q2_10_100/filelist.txt",
    "../../RECO/ep_10x250_Q2_100_1000/filelist.txt",
    "../../RECO/ep_10x250_Q2_1000_10000/filelist.txt"
  };
  std::vector<double> gen_xsecs = {0.70873205053123534,5.9758065033598498e-2,2.2867629538197093e-3,2.7215279714732617e-5}; // ub
  // std::vector<double> gen_xsecs = {5.9758065033598498e-2,2.2867629538197093e-3,2.7215279714732617e-5}; // ub
