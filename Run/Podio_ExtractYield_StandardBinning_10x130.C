...
void Podio_ExtractYield_StandardBinning_10x130() {
  // Settings
  Float_t E_ebeam = 10;
  Float_t E_pbeam = 130;
  ...
  std::vector<TString> filenames = {
    "../../RECO/ep_10x130_Q2_1_10/filelist.txt",
    "../../RECO/ep_10x130_Q2_10_100/filelist.txt",
    "../../RECO/ep_10x130_Q2_100_1000/filelist.txt",
    "../../RECO/ep_10x130_Q2_1000_10000/filelist.txt"
  };
  
  std::vector<double> gen_xsecs = {0.63928175476836346,4.7191206939697819e-2,1.5146539778048273e-3,8.1683285474953437e-6}; // ub
